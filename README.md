...
reddit and just general stuff I've encountered while working with Claude Code. A lot of my
work is on high-performance computing clusters, so you'll see some SLURM rules in here too.
The entry point is `main.md`, which the LLM should read.
